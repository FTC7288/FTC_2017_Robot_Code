...
@Autonomous(name="Red Left", group="AutoMote")
...
public class Red_Auto_Left extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        robot.top_left.setPosition(0.75);
        robot.top_right.setPosition(0.35);
        ...
        robot.left_motor.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.FLOAT);
        robot.left_motor_front.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.FLOAT);
        robot.right_motor.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.FLOAT);
        robot.right_motor_front.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.FLOAT);
    ...
    public void encoderDrive(double speed, double leftInches, double rightInches, double timeoutS) {
        ...
        if (opModeIsActive()) {
            ...
            while (opModeIsActive() &&
                ...
                telemetry.addData("Path1",  "Running to %7d :%7d :%7d :%7d", newLeftTarget,  newRightTarget, newLeftFrontTarget,  newRightFrontTarget);
                telemetry.addData("Path2",  "Running at %7d :%7d :%7d :%7d",
                        robot.left_motor.getCurrentPosition(),
                        robot.right_motor.getCurrentPosition(),
                        robot.left_motor_front.getCurrentPosition(),
                        robot.right_motor_front.getCurrentPosition());
    ...
    public void encoderStrafe(double speed, double distance, double timeoutS) {
        ...
        if (opModeIsActive()) {
            ...
            while (opModeIsActive() &&
                ...
                // Display it for the driver.
                telemetry.addData("Path1",  "Running to %7d :%7d :%7d :%7d", newLeftTarget_t,  newRightTarget_t, newLeftFrontTarget_t,  newRightFrontTarget_t);
                telemetry.addData("Path2",  "Running at %7d :%7d :%7d :%7d",
                        robot.left_motor.getCurrentPosition(),
                        robot.right_motor.getCurrentPosition(),
                        robot.left_motor_front.getCurrentPosition(),
